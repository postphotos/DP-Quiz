/*!
 * SlickQuiz-DP jQuery Plugin
 * Originally by author Julie Bellinson - http://www.jewlofthelotus.com
 * Updated by @author Leo Postovoit - www.postphotos.us
 * @license MIT
 */
...
var defaults = {
        ...
        var levels = {
            1: quizValues.info.level1, // 
            2: quizValues.info.level2, // 
            3: quizValues.info.level3, // 
            4: quizValues.info.level4, // 
            5: quizValues.info.level5,  // 
            5: quizValues.info.level6  // 
        };
        ...
        plugin.method = {
            ...
            calculateLevel: function(correctAnswers) {
                ...
                if (plugin.method.inRange(0, 0.15, percent)) {
                    level = 6;
                } else if (plugin.method.inRange(0.15, 0.28, percent)) {
                    level = 5;
                } else if (plugin.method.inRange(0.28, 0.42, percent)) {
                    level = 4;
                } else if (plugin.method.inRange(0.42, 0.58, percent)) {
                    level = 3;
                } else if (plugin.method.inRange(0.58, .72, percent)) {
                    level = 2;
                } else if (plugin.method.inRange(0.72, .100, percent)) {
                    level = 1;
                }
